...
function NavList({ navListItems, isVertical }) {
...
export default function MenuItems({ navListItems, isVertical = false }) {
    return (
            <div>
                <NavList navListItems={navListItems} isVertical={isVertical} />
            </div>
    );
}
