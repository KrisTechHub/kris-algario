    ...
    return (
            <Navbar className="mx-auto max-w-screen-xl p-2 lg:rounded-full lg:pl-6 tracking-wider">
                <div className="relative mx-auto flex items-center justify-between text-mypink-800 ">
                    ...
                    <Typography as="a" href="/Home" className="divide-x-2 divide-mypink-600 font-sans me-20 flex items-start mr-4 ml-2 cursor-pointer py-1.5 font-medium flex items-center">
