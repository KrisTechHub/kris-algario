            ...
            <div className="flex-row">
                ...
                <div className='pt-1'>
                    <a href={CV} download='AlgarioCV.pdf' target="_blank" rel="noopener noreferrer">
                        <button onClick={handleDownload} className="flex mt-8 font-RalewayMedium tracking-wider text-white text-sm rounded-lg p-2 bg-gradient-to-r from-mypink-600 to-mypurple-400 hover:from-mypink-500 hover:to-mypurple-200">
