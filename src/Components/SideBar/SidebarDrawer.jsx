...
export default function SidebarDrawer() {
    ...
    return (
        <div className="z-50 opacity-95 hidden lg:block lg:mt-[70px] xl:mt-[90px] xl:mt-[110px] w-16 text-mypink-800 bg-blue-gray-50 shadow-xl shadow-blue-gray-900/5 custom-rounded-tr custom-rounded-br fixed sb">    
